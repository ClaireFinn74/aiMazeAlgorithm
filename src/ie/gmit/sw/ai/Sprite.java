...
public class Sprite
{
	...
	public Sprite(String name, String... images) throws Exception //'...' is 0 or many
	{
		this.name = name;
	...
	//added this in within the workshop to explain FuzzyLogic
	/*public double engage (double weapon, double anger)
	{
		...
		double result = nn.process(weapon, anger);
		health+=result;
	...
	{ //Returns the next image frame in animation
		int idx = index;
